...
class WithdrawProcessorServiceImplTest {

    @Inject
    BankAccountServicePort bankAccountService;

    @Inject
    WithdrawProcessorImpl withdrawProcessor;
    ...
    void should_debitReceiverAndDebitEmitter_when_transactionIsValidated() {
        ...
        // Act
        Transaction actualTransaction = withdrawProcessor.processTransaction(transaction);
        ...
        expectedTransaction.setType(TransactionType.WITHDRAW);
        ...
        metadata.put("emitter_amount_after", "600.00");
        ...
        assertThat(emitterAccount.getBalance())
                .usingRecursiveComparison()
                .isEqualTo(Money.of(new BigDecimal("600.00")));
    }
}